...
function corrections() {
	...
	document.getElementById("enlarge5token").innerHTML += '<img src="images/train_icon.svg" height="110" width="115" alt="" style="position: relative; bottom: 50px;" />';
	document.getElementById("enlarge15token").innerHTML += '<img src="images/train_icon.svg" height="110" width="115" alt="" style="position: relative; top: -60px;" />';
	document.getElementById("enlarge25token").innerHTML += '<img src="images/train_icon.svg" height="110" width="115" alt="" style="position: relative; top: -60px;" />';
	document.getElementById("enlarge35token").innerHTML += '<img src="images/train_icon.svg" height="110" width="115" alt="" style="position: relative; top: -60px;" />';
	document.getElementById("enlarge12token").innerHTML += '<img src="images/electric_icon.svg" height="80" width="68" alt="" style="position: relative; top: -30px;" />';
	document.getElementById("enlarge28token").innerHTML += '<img src="images/water_icon.svg" height="100" width="118" alt="" style="position: relative; top: -50px;" />';
}
...
square[1] = new Square("MISERY AVENUE", "PRICE $60", "#5c062a", 60, 3, 2, 10, 30, 90, 160, 250);
square[2] = new Square("DEATH CHEST", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[3] = new Square("BANE AVENUE", "$60", "#5c062a", 60, 3, 4, 20, 60, 180, 320, 450);
square[4] = new Square("CHURCH TAX", "PAY 10% OR $200", "#FFFFFF");
square[5] = new Square("RAILROAD TO RUINATION", "PRICE $200", "#FFFFFF", 200, 1);
square[6] = new Square("TURMOIL TERRACE", "PRICE $100", "#1da9f0", 100, 4, 6, 30, 90, 270, 400, 550);
square[7] = new Square("CHANCE", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[8] = new Square("AGONY AVENUE", "PRICE $100", "#1da9f0", 100, 4, 6, 30, 90, 270, 400, 550);
square[9] = new Square("DREAD DRIVE", "PRICE $120", "#1da9f0", 120, 4, 8, 40, 100, 300, 450, 600);
square[10] = new Square("JUST VISITING", "", "#FFFFFF");
square[11] = new Square("GRAVE PLACE", "PRICE $140", "#cc287a", 140, 5, 10, 50, 150, 450, 625, 750);
square[12] = new Square("LIGHT COMPANY", "PRICE $150", "#FFFFFF", 150, 2);
square[13] = new Square("ABYSS AVENUE", "PRICE $140", "#cc287a", 140, 5, 10, 50, 150, 450, 625, 750);
square[14] = new Square("BLEAK STREET", "PRICE $160", "#cc287a", 160, 5, 12, 60, 180, 500, 700, 900);
square[15] = new Square("RAILROAD TO PERDITION", "PRICE $200", "#FFFFFF", 200, 1);
square[16] = new Square("PUNISHMENT PLACE", "PRICE $180", "#ff9900", 180, 6, 14, 70, 200, 550, 750, 950);
square[17] = new Square("DEATH CHEST", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[18] = new Square("APATHETIC PARK", "PRICE $180", "#ff9900", 180, 6, 14, 70, 200, 550, 750, 950);
square[19] = new Square("SUFFER STREET", "PRICE $200", "#ff9900", 200, 6, 16, 80, 220, 600, 800, 1000);
square[20] = new Square("FREE PARKING", "", "#FFFFFF");
square[21] = new Square("TORTURE TERRACE", "PRICE $220", "#851111", 220, 7, 18, 90, 250, 700, 875, 1050);
square[22] = new Square("CHANCE", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[23] = new Square("EVIL AVENUE", "PRICE $220", "#851111", 220, 7, 18, 90, 250, 700, 875, 1050);
square[24] = new Square("SINISTER AVENUE", "PRICE $240", "#851111", 240, 7, 20, 100, 300, 750, 925, 1100);
square[25] = new Square("RAILROAD TO BRIMSTONE", "PRICE $200", "#FFFFFF", 200, 1);
square[26] = new Square("ANGER AVENUE", "PRICE $260", "#f5d907", 260, 8, 22, 110, 330, 800, 975, 1150);
square[27] = new Square("ENVY AVENUE", "PRICE $260", "#f5d907", 260, 8, 22, 110, 330, 800, 975, 1150);
square[28] = new Square("BLOOD WORKS", "PRICE $150", "#FFFFFF", 150, 2);
square[29] = new Square("GLUTTONY GARDENS", "PRICE $280", "#f5d907", 280, 8, 24, 120, 360, 850, 1025, 1200);
square[30] = new Square("GO TO PURGATORY", "Go directly to Jail. Do not pass GO. Do not collect $200.", "#FFFFFF");
square[31] = new Square("SLOTH STREET", "PRICE $300", "#396039", 300, 9, 26, 130, 390, 900, 1100, 1275);
square[32] = new Square("LUST LANE", "PRICE $300", "#396039", 300, 9, 26, 130, 390, 900, 1100, 1275);
square[33] = new Square("DEATH CHEST", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[34] = new Square("GREED STREET", "PRICE $320", "#396039", 320, 9, 28, 150, 450, 1000, 1200, 1400);
square[35] = new Square("RAILROAD TO INFERNO", "PRICE $200", "#FFFFFF", 200, 1);
square[36] = new Square("CHANCE", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[37] = new Square("PRIDE PLACE", "PRICE $350", "#1382ba", 350, 10, 35, 175, 500, 1100, 1300, 1500);
square[38] = new Square("INFAMY TAX", "Pay $100", "#FFFFFF");
square[39] = new Square("DAMNATION", "$400", "#1382ba", 400, 10, 50, 200, 600, 1400, 1700, 2000);
...
chanceCards[10] = new Card("ADVANCE to Damnation.", function() { advance(39);});
chanceCards[11] = new Card("ADVANCE to Sinister Avenue. If you pass \"GO\" collect $200.", function() { advance(24);});
...
chanceCards[14] = new Card("ADVANCE to St. Grave Place. If you pass \"GO\" collect $200.", function() { advance(11);});
