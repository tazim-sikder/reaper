...
square[11] = new Square("GRAVE PLACE", "PRICE $140", "#FF0080", 140, 5, 10, 50, 150, 450, 625, 750);
square[12] = new Square("LIGHT COMPANY", "PRICE $150", "#FFFFFF", 150, 2);
square[13] = new Square("ABYSS AVENUE", "PRICE $140", "#FF0080", 140, 5, 10, 50, 150, 450, 625, 750);
square[14] = new Square("BLEAK STREET", "PRICE $160", "#FF0080", 160, 5, 12, 60, 180, 500, 700, 900);
square[15] = new Square("RAILROAD TO PERDITION", "PRICE $200", "#FFFFFF", 200, 1);
square[16] = new Square("PUNISHMENT PLACE", "PRICE $180", "#FFA500", 180, 6, 14, 70, 200, 550, 750, 950);
square[17] = new Square("DEATH CHEST", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[18] = new Square("APATHETIC PARK", "PRICE $180", "#FFA500", 180, 6, 14, 70, 200, 550, 750, 950);
square[19] = new Square("SUFFER STREET", "PRICE $200", "#FFA500", 200, 6, 16, 80, 220, 600, 800, 1000);
...
square[31] = new Square("SLOTH STREET", "PRICE $300", "#008000", 300, 9, 26, 130, 390, 900, 1100, 1275);
square[32] = new Square("LUST LANE", "PRICE $300", "#008000", 300, 9, 26, 130, 390, 900, 1100, 1275);
square[33] = new Square("DEATH CHEST", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[34] = new Square("GREED STREET", "PRICE $320", "#008000", 320, 9, 28, 150, 450, 1000, 1200, 1400);
